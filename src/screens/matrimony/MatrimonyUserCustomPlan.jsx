...
const MatrimonyUserCustomPlan = () => {
  ...
  return (
    <>
      <div className="MatrimonyUserCustomPlan">
        <div className="customPlan_heading">
          <h1 className="title">Custom Plan</h1>
          <p className="subTitle">
            You can edit plan for individual user profile here
          </p>
        </div>
...
export default MatrimonyUserCustomPlan;
